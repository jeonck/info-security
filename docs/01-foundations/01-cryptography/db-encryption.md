...
flowchart LR
    A["평문 데이터 노출"] -- "API / Plug-in / TDE 암호화" --> B["데이터 자산 보호 강화"]
...
**필요성**:  
 (**자산 보호**) 데이터베이스 내의 중요한 민감 정보를 암호화하여 비인가자의 접근을 차단함  
 (**컴플라이언스 준수**) 개인정보 보호법 등 법적 규제 요구 사항을 충족하고 보안 감사를 준비함  
 (**관리 오남용 방지**) 권한이 있는 관리자라도 암호화된 데이터에 직접 접근하는 것을 제한하여 유출을 방지함  

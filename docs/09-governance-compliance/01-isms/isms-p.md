...
flowchart LR
    A["개별 보안 관리"] -- "정보보호 및 개인정보보호 통합" --> B["전사적 보안 거버넌스"]
...
**통합 배경**:  
( **중복 해소** ) 유사 인증 제도( **ISMS** + **PIMS** )의 중복성 제거를 통한 기업의 행정적 부담 경감  
( **거버넌스 통합** ) 정보보안과 개인정보보호를 단일 관리체계 내에서 유기적으로 운영하여 효율성 제고  
( **보안 강화** ) 개인정보 유출 사고에 대한 대응력 강화 및 법적 준거성(컴플라이언스) 확보  

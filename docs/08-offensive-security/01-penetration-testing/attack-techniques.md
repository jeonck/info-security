...
## I. 공격자의 시각으로 보는 보안, 공격기법 분류의 필요성

**정의:** 사이버 공격을 단계·계층·목적 기준으로 체계적으로 분류하여 방어 전략 수립과 위협 인텔리전스 활용을 최적화하는 프레임워크

**필요성:** 공격 유형의 다양화·지능화(APT, 공급망 공격)에 따라 개별 대응이 아닌 Kill Chain 기반의 선제적·체계적 방어 체계 구축 필요

...
flowchart LR
    A["폐쇄망 (Air-gap)"] -- "IT/OT 융합 및 연결성 증대" --> B["계층적 방어 (Purdue 모델)"]
    style A fill:#f9f9f9,stroke:#333,stroke-width:1px
    style B fill:#e1f5fe,stroke:#01579b,stroke-width:1px
```

**정의**: 제조, 에너지, 교통 등 국가 기반 시설 및 산업 공정을 제어하는 운영 기술( **OT** ) 및 산업 제어 시스템( **ICS** )을 사이버 위협으로부터 보호하기 위한 보안 체계  

**주요 특징 및 보안 우선순위**:  
( **가용성 최우선** ) **IT** 보안이 기밀성을 중시하는 것과 달리, 24시간 중단 없는 운영과 서비스 연속성( **Availability** )을 최우선  
( **안전 중심** ) 사이버 공격이 물리적 사고로 직결될 수 있으므로 인명 및 설비의 안전( **Safety** ) 확보가 필수적  
( **폐쇄망 한계** ) 에어갭( **Air-gap** ) 환경의 붕괴에 대응하기 위해 퍼듀( **Purdue** ) 모델 기반의 계층적 망 분리와 통제 적용  
